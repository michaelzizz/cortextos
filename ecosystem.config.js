  ...
  apps: [
    {
      ...
      script: "/Users/michaelzizzadoro/cortextos/dist/daemon.js",
      args: '--instance ' + (process.env.CTX_INSTANCE_ID || "default"),
      cwd: "/Users/michaelzizzadoro/cortextos",
      env: {
        CTX_INSTANCE_ID: process.env.CTX_INSTANCE_ID || "default",
        CTX_ROOT: process.env.CTX_ROOT || "/Users/michaelzizzadoro/.cortextos/default",
        CTX_FRAMEWORK_ROOT: "/Users/michaelzizzadoro/cortextos",
        CTX_PROJECT_ROOT: "/Users/michaelzizzadoro/cortextos",
        CTX_ORG: process.env.CTX_ORG || "hq",
      },
      max_restarts: 50,
      restart_delay: 5000,
      autorestart: true,
    },
    {
      ...
      script: 'npm',
      args: 'start',
      cwd: "/Users/michaelzizzadoro/cortextos/dashboard",
      env: {
